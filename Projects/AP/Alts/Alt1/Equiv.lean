...
--   simp [playMove, ha]; simp [playAMoveAt]; split_ifs with h₁ <;> simp_all
-- 
...
-- --   all_goals clear! s; intro s m h₁ h₂ ht p hp
-- --   ·
-- --     -- simp [applyAMove] at ht hp ⊢
-- --     simp [applyAMove]
