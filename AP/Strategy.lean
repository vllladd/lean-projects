...
theorem grid_diff_subsingleton_of_subsingleton_pw_0_a_turn {g : Game} {n}
...
theorem grid_diff_subsingleton_of_state'₀_0_a_turn {g : Game} {n}
(h :  g.toState' = state'₀ 0) (ht : g.a_turn) :
(Set.univ \ (g.play n).grid).Subsingleton := by
  apply grid_diff_subsingleton_of_subsingleton_pw_0_a_turn <;>
  simp [h, ht]

theorem grid_diff_subsingleton_of_state'₀_0_not_a_turn {g : Game} {n}
(h :  g.toState' = state'₀ 0) (ht : ¬g.a_turn) :
(Set.univ \ (g.play n).grid).Subsingleton := by
  by_cases he : g.ended
...
theorem grid_diff_subsingleton_of_state'₀_0 {g : Game} {n}
(h :  g.toState' = state'₀ 0) :
(Set.univ \ (g.play n).grid).Subsingleton := by
  by_cases h₁ : g.a_turn
